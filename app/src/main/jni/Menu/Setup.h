...
void Init(JNIEnv *env, jobject thiz, jobject ctx, jobject title, jobject subtitle){
    //Set sub title
    setText(env, title, OBFUSCATE("<b>༺𝖅𝕱𝕸𝕺𝕯𝖅༻</b>"));

    //Set sub title
    setText(env, subtitle, OBFUSCATE("<b><marquee><p style=\"font-size:33\">"
                                      "<p style=\"color:green;\">〘ⓏⒻⓂ︎ⓄⒹⓏ ⓄⒻⒻⒾⒸⒾⒶⓁ 𝙼𝙾𝙱𝙸𝙻𝙴 𝙻𝙴𝙶𝙴𝙽𝙳𝚂 𝙵𝚁𝙴𝙴 𝙼𝙾𝙳 | 𝙳𝚁𝙾𝙽𝙴 𝚅𝙸𝙴𝚆 𝙾𝙽𝙻𝚈 | 𝚂𝙰𝙵𝙴 | 𝟹𝟸𝙱𝙸𝚃 𝚅𝙴𝚁𝚂𝙸𝙾𝙽</p> | "
                                      "𝟷.𝟾.𝟼𝟼.𝟿𝟺𝟸𝟷 |</p>"
                                      "</marquee></b>"));
    ...
    //Toast Example
    Toast(env,ctx,OBFUSCATE("𝚉𝙵𝙼𝙾𝙳𝚉 𝙾𝙵𝙵𝙸𝙲𝙸𝙰𝙻"),ToastLength::LENGTH_LONG);
