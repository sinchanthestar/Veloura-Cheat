...
bool e_elements::begin_child_ex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilled(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x, size.y), ImColor(0.06f, 0.06f, 0.06f, 0.44f), 4.0f);
    ...
    parent_window->DrawList->AddText(bold, 32.0f, parent_window->DC.CursorPos + ImVec2(16, 0), ImColor(147, 190, 66), name);
